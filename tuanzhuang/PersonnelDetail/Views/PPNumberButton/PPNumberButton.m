...
- (void)setupUI
{
    ...
    _textField.keyboard = KEYBOARDTYPE_NUMBER;
...
- (void)textFieldDidEndEditing:(UITextField *)textField
{
    ...
    [self updateDisplayZeroNumberForTextField];
}
...
- (void)setBorderColor:(UIColor *)borderColor
{
    ...
    _decreaseBtn.layer.borderWidth = _borderWidth;
    _decreaseBtn.layer.borderColor = [borderColor CGColor];
    
    _increaseBtn.layer.borderWidth = _borderWidth;
...
#pragma mark - Private Methods For Display Zero Number
-(void)updateDisplayZeroNumberForTextField{
    
    if (!self.displayZeroNumber && 0 == _textField.text.integerValue) {
        _textField.text = @"";
    }
